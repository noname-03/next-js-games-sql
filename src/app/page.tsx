...
// Statistik exercise & progress untuk sekumpulan level (query agregat, 2 query)
function getLevelStats(levelIds: number[]) {
...
export default async function Home({ searchParams }: { searchParams: SearchParams }) {
  ...
  const statsAll = getLevelStats(allLevels.map((l) => l.id));
